...
Route::get('api/ofisler/{countyId}', 'OfficeApiController@offices');
Route::get('api/ilceler/{cityId}', 'OfficeApiController@counties');
Route::get('api/iller', 'OfficeApiController@main');
